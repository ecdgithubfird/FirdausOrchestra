        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                @if(count($$module_name) > 0)
                    <a href='{{ route("backend.$module_name.emptyTrash") }}' class="btn btn-danger" data-toggle="tooltip" data-method="DELETE"  data-token="{{csrf_token()}}" data-confirm="Are you sure?" title="{{ ucwords($module_name) }} List"><i class="fas fa-trash-alt"></i> Empty Trash</a>
                @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href='{{route("backend.$module_name.deleteData",$module_name_singular)}}' class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" data-confirm="Are you sure?" title="{{__('Delete')}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
