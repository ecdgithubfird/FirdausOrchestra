        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="row">
                    ...
                    @if($module_name == "mails")
                        <div class="col-4 mt-4">
                            {{--<x-backend.buttons.send :route="route('send_mail', ['id' => $data->id ])" /> --}}
                            <a href='{{route("backend.$module_name.send_mail", $data->id)}}' class="btn btn-info">Send Mail</a>
                    ...
                    <div class="col-8 mt-4">
                        <div class="float-end">
                            ...
                            <a href='{{route("backend.$module_name.destroy", $data)}}' class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" data-confirm="Are you sure?" title="{{__('Delete')}}"><i class="fas fa-trash-alt"></i></a>
                            @endcan
