...
class PerformancesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'performance::frontend';
    ...
    public function viewPerformance(Request $request,$slug)
    {
        $fields = Performance::where('slug',$slug)->first();
        $connect_menus = Menu::where('group_name','Connect')->where('status',1)->whereNull('deleted_at')->get();
        return view(
            "frontend.event-details",
        compact('fields','connect_menus')
        );
    }
}
