...
Route::group(['namespace' => '\Modules\Menu\Http\Controllers\Backend', 'as' => 'backend.', 'middleware' => ['web', 'auth', 'can:view_backend'], 'prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::post("$module_name/menu_order", ['as' => "$module_name.menuCount", 'uses' => "$controller_name@menuCount"]);
    Route::post("$module_name/menu_select", ['as' => "$module_name.menuSelect", 'uses' => "$controller_name@menuSelect"]);
